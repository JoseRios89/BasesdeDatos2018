...
public class DBScripts {
    ...
    private static final String LOAD_DATABASE_FILE = "/sistema/scripts/database.sql";
    private static final String LOAD_TABLES_FILE = "/sistema/scripts/tables.sql";
